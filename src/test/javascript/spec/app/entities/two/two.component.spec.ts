...
import { TwoComponent } from 'app/entities/two/two.component';
import { TwoService } from 'app/entities/two/two.service';
import { Two } from 'app/shared/model/two.model';

describe('Component Tests', () => {
  describe('Two Management Component', () => {
    let comp: TwoComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.twos && comp.twos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
